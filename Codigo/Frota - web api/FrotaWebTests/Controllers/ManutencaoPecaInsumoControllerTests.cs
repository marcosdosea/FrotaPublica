...
namespace FrotaWeb.Controllers.Tests
{
    ...
    public class ManutencaoPecaInsumoControllerTests
    {
        ...
        public void Initialize()
        {
            ...
            mockManutencaoPecaInsumoService.Setup(service => service.Get(1, 1001))
        ...
        {
            // Act
            var result = controller!.Details(1, 1001);
            // Assert
            Assert.IsInstanceOfType(result, typeof(ViewResult));
            ViewResult viewResult = (ViewResult)result;
        ...
        {
            // Act
            var result = controller!.Edit(1, 1001);
            // Assert
            Assert.IsInstanceOfType(result, typeof(ViewResult));
            ViewResult viewResult = (ViewResult)result;
            Assert.IsInstanceOfType(viewResult.ViewData.Model, typeof(ManutencaoPecaInsumoViewModel));
        ...
        {
            // Act
            var result = controller!.Delete(1, 1001);
