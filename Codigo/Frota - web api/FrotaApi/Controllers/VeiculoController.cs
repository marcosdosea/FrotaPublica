...
namespace FrotaApi.Controllers
{
    ...
    public class VeiculoController : ControllerBase
    {
        ...
        [HttpGet("disponiveis")]
        public ActionResult<VeiculoDisponiveisResponseModel> GetTodosVeiculosDisponiveis(
            [FromQuery] string? placa = null)
        {
            try
            {
                ...
                List<Veiculo> veiculosResult = _veiculoService.GetAllFilterByPlaca(idFrota, idUnidadeAdm, placa ?? string.Empty) ?? new List<Veiculo>();

                return Ok(new VeiculoDisponiveisResponseModel
                {
                    TotalItems = veiculosResult.Count(),
