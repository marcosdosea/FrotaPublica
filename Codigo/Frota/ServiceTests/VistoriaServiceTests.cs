...
namespace Service.Tests
{
    ...
    public class VistoriaServiceTests
    {
        ...
        public void CreateTest()
        {
            ...
            // Assert
            Assert.AreEqual(2, vistoriaService.GetAll(1).Count());
        ...
        public void DeleteTest()
        {
            ...
            // Assert
            Assert.AreEqual(1, vistoriaService.GetAll(1).Count());
