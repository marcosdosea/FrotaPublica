...
namespace FrotaWeb.Controllers.Tests
{
	...
	public class SolicitacaoManutencaoControllerTests
	{
		...
		public void Initialize()
		{
			...
			mockSolicitacaoService.Setup(service => service.GetAll())
			...
			mockSolicitacaoService.Setup(service => service.Edit(It.IsAny<Solicitacaomanutencao>()))
				.Verifiable();
			mockSolicitacaoService.Setup(service => service.Create(It.IsAny<Solicitacaomanutencao>()))
				.Verifiable();
